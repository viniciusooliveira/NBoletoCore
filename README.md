> NBoletoCore is a library for Brazil only payments, so all documents are in portuguese.

---
# NBoletoCore - Boleto bancário para .NET Core

### NBoletoCore é um port do NBoleto para .NET Core

[Projeto original](https://github.com/mbdavid/NBoleto)
